...
const [showAllHikes, setShowAllHikes] = useState(false); // To toggle between latest and all
  ...
  useEffect(() => {
    ...
    const calculateAllValues = () => {
      ...
      const finalPaidDays = 30 - (formData.lopDays || 0);
      
      // Calculate adjusted basic pay based on final paid days
      let basicPay = basicSalary;
      if ((formData.lopDays || 0) > 0 || finalPaidDays < 30) {
...
const handleEditSalary = async (salary) => {
  try {
    ...
    setFormData({
      ...
      casualLeaveTaken: salaryDetails.casualLeaveTaken || 0,
      sickLeaveTaken: salaryDetails.sickLeaveTaken || 0,
  ...
  const handleDownloadPayslip = async (payslipId, payslip) => {
    try {
      ...
      a.href = url;
      // Use payslip name and month/year if available, otherwise fallback to ID
      a.download = payslip ? `${payslip.employeeId}_${payslip.month}_${payslip.year}.pdf` : `payslip-${payslipId}.pdf`;
              ...
              <div className="salary-detail-container">
                ...
                <div className="detail-section">
                  ...
                  <div className="detail-grid">
                    ...
                    <div className="detail-item">
                      <span className="detail-label">Casual Leave Taken:</span>
                      <span className="detail-value">{selectedSalaryDetail.casualLeaveTaken}</span>
                    </div>
                    <div className="detail-item">
                      <span className="detail-label">Sick Leave Taken:</span>
                      <span className="detail-value">{selectedSalaryDetail.sickLeaveTaken}</span>
                    </div>
                    <div className="detail-item">
                      <span className="detail-label">Total Leaves Taken:</span>
                      <span className="detail-value highlight">
                        {(selectedSalaryDetail.casualLeaveTaken || 0) + (selectedSalaryDetail.sickLeaveTaken || 0)}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                {hikePercentage && (
                  <div className="hike-preview">
                    ...
                    <div className="hike-note">
                      <p><strong>Note:</strong> The new salary will be effective from {hikeStartDate ? new Date(hikeStartDate).toLocaleDateString() : 'selected date'}. Current salary record will be disabled and moved to disabled records on that date.</p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      ...
                      <div className="form-group">
                        ...
                        />
                        <small className="form-help">
                          Enter number of casual leaves taken this month
                        </small>
                      </div>
                      <div className="form-group">
                        ...
                        />
                        <small className="form-help">
                          Enter number of sick leaves taken this month
                        </small>
                      </div>
                    </div>
                    ...
                    <div className="calculated-values-section">
                      ...
                      <div className="calculated-grid">
                        ...
                        <div className="calculated-item">
                          <span className="calculated-label">Total Leaves Taken:</span>
                          <span className="calculated-value highlight">
                            {(formData.casualLeaveTaken || 0) + (formData.sickLeaveTaken || 0)}
                          </span>
                        </div>
                      </div>
